...
export const defaultConfig: AiConfig = { model: "", imageModel: "", videoModel: "", textModel: "", models: [], systemPrompt: "", videoSeconds: "6", vquality: "720", quality: "auto", size: "1:1", resolution: "1k", outputFormat: "jpeg", background: "auto", count: "1" };
