    ...
    try {
        ...
        assert.deepEqual(
            ...
            [
                ...
                { url: "/api/v1/canvas/projects", method: "POST", data: { id: "project-1", title: "新画布", document } },
                { url: "/api/v1/canvas/projects/import", method: "POST", data: { projects: [{ id: "project-1", title: "导入画布", document }] } },
                { url: "/api/v1/canvas/projects/project-1", method: "PUT", data: { revision: 1, title: "更新画布", document } },
